...
const OFFICES: readonly Office[] = [
  {
    ...
    address: "A/514, Crystal Plaza, New Link Rd, Veera Desai Industrial Estate, Andheri West, Mumbai, Maharashtra 400053",
    mapUrl:
  ...
  },
  {
    ...
    type: "BRANCH",
    image: "https://images.unsplash.com/photo-1519501025264-65ba15a82390?auto=format&fit=crop&w=700&h=400&q=80",
    address: "Shop No. 3, Sabri Nagar, Rasla Khedi, Bhopal, Madhya Pradesh - 462038",
    mapUrl: "https://www.google.com/maps/search/?api=1&query=Shop+No.+3,+Sabri+Nagar,+Rasla+Khedi,+Bhopal,+Madhya+Pradesh+462038",
    cardHref: "/locations-detectives-agency-in-bhopal",
    phone: "+91 99304 03115",
    email: "info@hsdetectives.com",
  },
  {
    ...
    type: "BRANCH",
    image: "https://images.unsplash.com/photo-1560179707-f14e90ef3623?auto=format&fit=crop&w=700&h=400&q=80",
    address: "203-A, Second Floor, SCO 139-140, Madhya Marg, Sector 9-C, Chandigarh - 160009",
    mapUrl: "https://www.google.com/maps/search/?api=1&query=203-A,+Second+Floor,+SCO+139-140,+Madhya+Marg,+Sector+9-C,+Chandigarh+160009",
    cardHref: "/locations-detectives-agency-in-chandigarh",
    phone: "+91 99304 03115",
    email: "info@hsdetectives.com",
  },
  {
