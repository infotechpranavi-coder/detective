      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 text-center">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="mt-16">
            <a href="/locations" className="inline-flex items-center gap-2 font-space text-[11px] uppercase tracking-widest text-accent hover:text-foreground transition-colors border-b border-accent/30 hover:border-foreground/40 pb-1">
