...
export default function PackageCta() {
  ...
  return (
    <section ref={containerRef} className="relative py-32 overflow-hidden border-t-2 border-black bg-white">
      ...
      {/* Overlay Gradient */}
      <div className="absolute inset-0 bg-gradient-to-t from-white via-transparent to-white pointer-events-none z-[1]" />
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 text-center">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="font-playfair text-4xl md:text-5xl lg:text-7xl text-black uppercase tracking-wider mb-8 leading-[1.1]">
            Need A Custom <span className="text-accent italic">Quote?</span>
          </motion.h2>

          <motion.p variants={fadeUp} className="font-inter text-black/80 text-base md:text-lg mb-12 max-w-2xl leading-relaxed">
