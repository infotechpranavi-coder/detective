  ...
  return (
    <section className="py-24 bg-background border-b border-foreground/5">
      <div className="container mx-auto px-6 lg:px-12 space-y-12">
        ...
        {/* CARD 1 - Personal */}
        <motion.div 
          className="grid grid-cols-1 lg:grid-cols-2 rounded-lg overflow-hidden border border-foreground/10 group h-auto lg:h-[400px]"
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <div className="bg-white dark:bg-[#0A0A0A] p-10 lg:p-16 flex flex-col justify-center">
            <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <motion.h3 variants={fadeUp} className="font-playfair text-3xl md:text-4xl text-foreground uppercase tracking-wider mb-6">Personal <span className="text-foreground/40 italic">Investigation</span></motion.h3>
              <motion.p variants={fadeUp} className="font-inter text-sm md:text-base text-foreground/60 leading-relaxed mb-8">
              ...
              <motion.div variants={fadeUp}>
                <Link href="/contact" className="inline-flex items-center gap-3 text-accent font-space text-xs uppercase tracking-widest hover:text-foreground transition-colors border-b border-accent/30 hover:border-foreground/40 pb-1">
        ...
        >
          ...
          <div className="bg-white dark:bg-[#0A0A0A] p-10 lg:p-16 flex flex-col justify-center order-2 lg:order-1">
            <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }}>
              ...
              <motion.h3 variants={fadeUp} className="font-playfair text-3xl md:text-4xl text-foreground uppercase tracking-wider mb-6">Business <span className="text-foreground/40 italic">Investigation</span></motion.h3>
              <motion.p variants={fadeUp} className="font-inter text-sm md:text-base text-foreground/60 leading-relaxed mb-8">
